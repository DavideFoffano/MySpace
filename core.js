...
const TRAVEL_TEMPLATES=[
  {id:'mare',icon:'🏖️',name:'Mare',color:'#6dbb8a',cats:[
    {cat:'Documenti',items:['Carta d\'identità','Tessera sanitaria','Biglietti','Prenotazione hotel','Contanti','Portafogli','Copie documenti']},
    {cat:'Abbigliamento',items:['Magliette','Pantaloni','Camicie','Canotte','Felpe','Cintura','Cappello','Occhiali da sole','Mutande','Calzini','Pigiama','Vestiti casa','Sandali','Infradito']},
    {cat:'Spiaggia',items:['Costume da bagno','Costume extra','Mutande costume','Asciugamano grande','Telo mare','Crema solare SPF50','Crema solare corpo','Doposole','Borsa mare','Zaino','Cuffia nuoto']},
    {cat:'Igiene',items:['Accappatoio','Shampoo','Balsamo','Prodotti capelli','Docciaschiuma','Spazzolino','Dentifricio','Deodorante','Profumo','Rasoio','Pinzette','Kit unghie','Cuffia capelli']},
    {cat:'Farmaci',items:['Tachipirina','Oki','Antidolorifici','Antistaminico','Cerotti','Farmaci personali','Crema antizanzare']},
    {cat:'Tech & Altro',items:['Caricatori e powerbank','Presa elettrica','Cuffie','Cassa bluetooth','Occhiali e gioielli','Portaocchiali','Gomme da masticare','Fazzoletti','Sacchetti','Chiavi']},
  ]},
  {id:'montagna',icon:'🏔️',name:'Montagna',color:'#a8c26b',cats:[
    {cat:'Documenti',items:['Carta d\'identità','Assicurazione','Biglietti','Mappa cartacea','Portafogli','Contanti']},
    {cat:'Abbigliamento',items:['Giacca impermeabile','Felpa','Maglione','Pantaloni trekking','Pantaloni casual','Magliette','Scarpe da trekking','Calzini tecnici','Calzini extra','Mutande','Guanti','Berretto','Strati termici','Gilet','Cintura']},
    {cat:'Equipaggiamento',items:['Zaino','Bastoni trekking','Torcia frontale','Borraccia','Thermos','Mappa/GPS','Crema solare','Fischietto']},
    {cat:'Igiene',items:['Accappatoio','Shampoo','Balsamo','Bagnoschiuma','Spazzolino','Dentifricio','Deodorante','Prodotti capelli','Salviette umide','Crema mani','Kit unghie']},
    {cat:'Farmaci',items:['Tachipirina','Oki','Antidolorifici','Cerotti','Bende','Disinfettante spray','Farmaci di quota','Antinausea']},
    {cat:'Tech & Altro',items:['Caricatori e powerbank','Presa elettrica','Cuffie','Cassa bluetooth','Fazzoletti','Sacchetti','Occhiali','Portaocchiali','Chiavi','Copie documenti']},
  ]},
  {id:'city',icon:'🌆',name:'City Break',color:'#9b8fc2',cats:[
    {cat:'Documenti',items:['Carta d\'identità','Biglietti','Prenotazione hotel','Carte di credito','Contanti locali','Portafogli','Copie documenti']},
    {cat:'Abbigliamento',items:['Magliette','Pantaloni','Camicie','Canotte','Outfit elegante','Scarpe comode','Scarpe eleganti','Giacca leggera','Impermeabile leggero','Mutande','Calzini','Cintura','Cappello']},
    {cat:'Igiene',items:['Shampoo','Docciaschiuma','Spazzolino','Dentifricio','Deodorante','Profumo','Rasoio','Kit igiene ridotto']},
    {cat:'Tech & Altro',items:['Caricatore telefono','Power bank','Cuffie','Cassa bluetooth','Adattatore prese','Fotocamera','Occhiali e gioielli','Fazzoletti','Sacchetti','Chiavi','Guida turistica','Ombrello pieghevole']},
  ]},
  {id:'business',icon:'💼',name:'Business',color:'#c97a4a',cats:[
    {cat:'Documenti',items:['Passaporto','Carta d\'identità','Biglietti','Biglietti da visita','Documenti riunione','Prenotazione hotel','Polizza assicurativa','Portafogli','Copie documenti']},
    {cat:'Abbigliamento',items:['Abito/Completo','Camicia x2','Cravatta','Scarpe eleganti','Cintura','Calzini formali','Mutande','Abbigliamento casual sera']},
    ...
    {cat:'Igiene',items:['Accappatoio','Shampoo','Bagnoschiuma','Spazzolino','Dentifricio','Deodorante','Rasoio','Dopobarba','Profumo','Kit emergenza macchie']},
    {cat:'Altro',items:['Fazzoletti','Sacchetti','Occhiali e gioielli','Chiavi','Gomme da masticare']},
  ]},
  {id:'volo',icon:'✈️',name:'Volo lungo',color:'#d4a84b',cats:[
    {cat:'Documenti',items:['Passaporto','Visto','Carta imbarco','Assicurazione viaggio','Prenotazione hotel','Vaccinazioni','Contatti emergenza','Portafogli','Copie documenti']},
    {cat:'A bordo',items:['Cuscino da viaggio','Mascherina occhi','Tappi orecchie','Coperta sottile','Calzini volo','Snack','Fazzoletti','Gomme da masticare']},
    {cat:'Abbigliamento',items:['Magliette','Pantaloni','Camicie','Felpe','Mutande','Calzini','Abbigliamento formale','Costume','Cappello','Occhiali da sole']},
    {cat:'Tech',items:['Adattatore prese universale','Power bank grande','Caricatori','Cuffie noise cancelling','Tablet/eReader','SIM locale','Cassa bluetooth']},
    {cat:'Igiene',items:['Accappatoio','Shampoo','Bagnoschiuma','Spazzolino','Dentifricio','Deodorante','Prodotti capelli','Kit unghie']},
    {cat:'Farmaci',items:['Medicinali personali','Tachipirina','Antidiarroico','Antistaminico','Sonnifero leggero','Disinfettante mani','Kit pronto soccorso']},
    {cat:'Altro',items:['Occhiali e gioielli','Portaocchiali','Sacchetti','Chiavi']},
  ]},
  {id:'weekend',icon:'🌿',name:'Weekend',color:'#7ab8b0',cats:[
    {cat:'Documenti',items:['Carta d\'identità','Prenotazione','Contanti','Portafogli']},
    {cat:'Abbigliamento',items:['Magliette','Pantaloni','Pigiama','Mutande','Calzini','Scarpe comode','Scarpe eleganti','Giacca','Cintura']},
    {cat:'Igiene',items:['Spazzolino','Dentifricio','Shampoo','Docciaschiuma','Deodorante','Rasoio']},
    {cat:'Tech & Altro',items:['Caricatore telefono','Cuffie','Power bank','Fazzoletti','Chiavi','Libro/eReader','Snack']},
  ]},
];
